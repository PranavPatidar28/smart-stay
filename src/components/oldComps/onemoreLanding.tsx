            ...
            <div className="flex items-center justify-center hero-content-item w-full max-w-xl m-auto" style={{animationDelay: '1.2s'}}>  
              <div className="relative group w-full flex justify-center">
                ...
                <div className="relative w-full max-w-xl h-[480px]">
                  ...
                  {/* Image 1 - Bottom Left */}
                  <div className="absolute bottom-4 left-2 w-65 h-68 rounded-2xl overflow-hidden shadow-2xl border-2 border-[#312E81]/40 hover:scale-105 hover:rotate-1 transition-transform duration-200 ease-out hover:border-[#8B5CF6]/60 z-10 hover:z-20">
                  ...
                  {/* Image 2 - Top Right */}
                  <div className="absolute top-2 right-2 w-55 h-76 rounded-2xl overflow-hidden shadow-2xl border-2 border-[#312E81]/40 hover:scale-105 hover:-rotate-1 transition-transform duration-200 ease-out hover:border-[#8B5CF6]/60 z-10 hover:z-20">
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1E1B4B]/50 via-transparent to-transparent rounded-2xl"></div>
                    <img 
                  ...
                  {/* Image 3 - Center (Main) */}
                  <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-88 rounded-2xl overflow-hidden shadow-2xl border-2 border-[#8B5CF6]/50 hover:scale-105 hover:rotate-1 transition-transform duration-200 ease-out hover:border-[#A78BFA]/80 z-15 hover:z-25">
                    <div className="absolute inset-0 bg-gradient-to-t from-[#1E1B4B]/50 via-transparent to-transparent rounded-2xl"></div>
                    <img 
                    ...
                    />
                    {/* Featured Badge */}
                    <div className="absolute top-3 right-3 bg-gradient-to-r from-[#8B5CF6] to-[#6366F1] px-3 py-1.5 rounded-full shadow-lg">
                ...
                <div className="absolute -bottom-13 right-16 bg-gradient-to-r from-[#8B5CF6]/25 to-[#6366F1]/25 backdrop-blur-xl p-4 rounded-2xl border border-[#8B5CF6]/40 shadow-[0_0_20px_rgba(139,92,246,0.4)] hover:scale-105 transition-all duration-300 ease-out min-w-[100px] z-40 hover:shadow-[0_0_30px_rgba(139,92,246,0.6)] group ">
                  ...
                  {/* Decorative Corner */}
                  <div className="absolute -top-1 -right-0.5 w-2 h-2 bg-gradient-to-br from-[#A78BFA] to-[#818CF8] rounded-full opacity-60"></div>
                </div>
                <div className="absolute bottom-8 -right-8 bg-gradient-to-r from-[#6366F1]/25 to-[#8B5CF6]/25 backdrop-blur-xl p-4 rounded-2xl border border-[#6366F1]/40 shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:scale-105 transition-all duration-300 ease-out min-w-[100px] z-40 hover:shadow-[0_0_30px_rgba(99,102,241,0.6)] group ">
                  <div className="text-center">
                  ...
                  {/* Decorative Corner */}
                  <div className="absolute -bottom-1 -left-0.5 w-2 h-2 bg-gradient-to-br from-[#818CF8] to-[#A78BFA] rounded-full opacity-60"></div>
                </div>
                {/* Verification Badge */}
